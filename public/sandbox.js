 ...
 * refresh in the extension. Auto-refresh is ON by default (opt-out, per portal). */
 ...
 // Scoped to the UTILITY group: the inverter picker above reuses the same
 // .ar-picker markup and sits EARLIER in the DOM, so an unscoped querySelector
 // would grab the wrong panel.
