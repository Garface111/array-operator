 ...
 */
 var STEPS = [
    ...
    },
    {
      ...
      kicker: "8 · Hands-off",
      title: "Utility portals — do you need to fill any in?",
      lede:
        "Do you need to fill in any utility portals? This is where you do that. Bill-capture logins (GMP, VEC, SmartHub co-ops…) go in Account under <b>Utility portals</b> — the same Auto-refresh vault as your inverters. Skip it if you're only tracking generation.",
      kind: "step",
      callout:
