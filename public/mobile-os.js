...
(function () {
  ...
  var LEARN = [
    ...
    },
    {
      ...
      label: "Resources",
      sub: "Rates & rules",
      why: "Net-metering rates and local context (Analysis → Resources).",
      prompt:
        "What does Analysis → Resources help with for VT/New England operators, and when should I open it?",
      hash: "#resources",
    ...
    },
    {
      ...
      story: "fleet",
      label: "Repairs",
      sub: "Agent watches O&M",
      why: "Chat-first: set up your repair team in conversation; EnergyAgent drafts outreach when hardware faults.",
      prompt:
        "Tell me about my current repair system.",
      hash: "#ops",
